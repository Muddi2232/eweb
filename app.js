var products = [
  ...
  for (var i = 0; i < products.length; i++) {
    ...
    <div class="mt-4">
      ...
      <button onclick = "favorite (this)" class = 'fav outline border-primary px-4'><i class="fa-solid fa-heart"></i></button>
      </div>
  ...
  function addToCart(element) {
    ...
    allProducts.innerHTML = favNumber;
    function favorite(element){
      if (favNumber.innerText== "favorite"){
         favNumber.innerText= favNumber.innerText = red
      }
    }
  }